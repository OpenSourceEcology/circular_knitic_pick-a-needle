...
translate([((c2ID+(pMgroove*2))/2)*cos(90-(pMd1e-pMd0)),0,pPspace2])
...
translate([(((c2ID+(pMgroove*2))/2)*cos(90-(pMd1e-pMd0)))+pMshelfX,0,0])
...
//chamfered cut
mirror([1,0,0])
translate([(((c2ID+(pMgroove*2))/2)*cos(90-(pMd1e-pMd0)))-pMshelfchamfR,0,pPspace2+pPplate2])
minkowski(){
...
//mounting bolt holes
            //1
translate([0,(cos(pMd1e-pMd0)*((pMID/2)+(pMshelfBoltD)+pMgroove)),0])
translate([-((((c2ID+(pMgroove*2))/2)*cos(90-(pMd1e-pMd0)))+(pMshelfX/2)),0,0])
